...
export const wx_auth = recomId =>
  `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${ appid }&redirect_uri=${ encodeURIComponent(`${ window.location.protocol }${ baseUrl }${ window.location.pathname }${ window.location.search }`) }&response_type=code&scope=${ scope }&state=STATE#wechat_redirect`
